...
class OAuthUserController
{
    public function connect(
        ...
        if (!isset($query_params['code']) || !\is_string($query_params['code'])) {
            ...
            if ($token_name === null || $token_value === null || !$csrf_guard->validateToken($token_name, $token_value)) {
        ...
        try {
            ...
            exit('Your access token has expired. Try again.');
        ...
        try {
            ...
            exit('Failed to grab user details from OAuth provider.');
        ...
        if ($user_oauth_token) {
            ...
            if ($user_oauth_token->getExpiresTimestamp()->getTimestamp() < \time()) {
    ...
    public function register(
        ...
        if ($existing_token) {
            exit('oauth connection already exists');
